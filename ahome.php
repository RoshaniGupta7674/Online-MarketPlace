...
<body class="box">
    ...
    <!-- <video autoplay muted loop id="myVideo">
        ...
        <div class="geeks">
          <font color="" size=7 face="algerian">Welcome Admin!!!</font><br>
          <font face="agency fb" size=4> Your Dashboard is Ready!!!</font>
        </div>
        <div class="geeks2">
          <img src="imgs/dbbg1.png" alt="" width="500px" height="350px">
        </div>
