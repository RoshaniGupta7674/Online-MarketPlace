...
<body> 
    ...
    <nav>
        ...
        <ul class="nav-links">
            <li><a href='home.php' target='f2' style='display: none;'></a></li>
            <li><a href="vhome.php" target="f2">Home</a></li>
            <li><a href="addprod.php" target="f2">Add Product</a></li>
            <li><a href="removeprod.php" target="f2">Remove Product</a></li>
            <li><a href="vprodlist.php" target="f2">Product List</a></li>
            <li><a href="orders.php" target="f2">Order List</a></li>
