...
<body>
    <form action="vendordb.php" method='post'>
        ...
        echo "<tr><th>Name</th><th>Phone No.</th><th>DOB</th><th>Aadhar No.</th><th>Status</th><th>Permission</th></tr>";
        while ($row = @mysqli_fetch_array($result)) {
            echo "<tr>";
            echo "<td>" . $row['dname'] . "</td>";
            echo "<td>" . $row['dphno'] . "</td>";
            echo "<td>" . $row['dob'] . "</td>";
            echo "<td>" . $row['dadharcardno'] . "</td>";
            echo "<td>" . $row['status'] . "</td>";
            echo "<td>";
            echo "<select name='permission[" . $row['dtid'] . "]' required>
                    <option value='Permit'" . ($row['status'] == 'Permit' ? ' selected' : '') . ">Permit</option>
                    <option value='Restrict'" . ($row['status'] == 'Restrict' ? ' selected' : '') . ">Restrict</option>
                  </select>";
            echo "</td>";
            echo "</tr>";
        }
