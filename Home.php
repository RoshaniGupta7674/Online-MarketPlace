...
<body class="box">
    ...
    <!-- <video autoplay muted loop id="myVideo">
        ...
        <div class="geeks">
          <font color="" size=7 face="algerian">Crafted with care, delivered to you</font><br>
          <font face="agency fb">Quality you can trust, at your fingertips</font>
        </div>
        <div class="geeks2">
          <img src="imgs/Homebgx.png" alt="" width="500px" height="350px">
